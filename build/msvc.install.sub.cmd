...
xcopy /Y /S /E "temp\libzip\bin\*.exe" "%INSTALL_PATH_BIN%\"
xcopy /Y /S /E "temp\libzip\bin\*.dll" "%INSTALL_PATH_BIN%\"
...
xcopy /Y /S /E "temp\libzip\bin\*.exe" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\libzip\bin\*.dll" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\libzip\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\libzip\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
